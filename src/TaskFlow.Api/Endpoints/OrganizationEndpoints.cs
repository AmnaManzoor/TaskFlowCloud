...
public static class OrganizationEndpoints
{
    public static IEndpointRouteBuilder MapOrganizationEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPut("/{id:guid}/members/{userId}", UpdateMemberRoleAsync)
            .AddEndpointFilter<ValidationFilter<UpdateOrganizationMemberRoleRequest>>();
    ...
    private static async Task<IResult> GetAllAsync(
        [AsParameters] OrganizationListQuery query,
        IOrganizationService service,
        ClaimsPrincipal user,
        CancellationToken cancellationToken)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Results.Created($"/api/organizations/{id}/members/{response.UserId}", response);
    }
